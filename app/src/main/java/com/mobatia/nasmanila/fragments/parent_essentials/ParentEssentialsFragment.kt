 ...
 */
class ParentEssentialsFragment(s: String, tabParentEssentialsReg: String) : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ParentEssentialsFragment.
         */
        // TODO: Rename and change types and number of parameters
//        @JvmStatic
//        fun newInstance(param1: String, param2: String) =
//            ParentEssentialsFragment(
